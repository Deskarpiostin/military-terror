...
void ClientPrecache( void )
{
	...
	PRECACHE_SOUND( "player/pl_death1.wav" );
	PRECACHE_SOUND( "player/pl_death2.wav" );		
	PRECACHE_SOUND( "player/pl_death3.wav" );
	PRECACHE_SOUND( "player/pl_death4.wav" );
	PRECACHE_SOUND( "player/pl_death5.wav" );
