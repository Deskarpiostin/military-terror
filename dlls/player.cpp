...
void CBasePlayer::Pain( void )
{
	...
	flRndSound = RANDOM_FLOAT( 0.0f, 0.5f ); 

	if( flRndSound <= 0.0f )
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_pain1.wav", 1, ATTN_NORM );
	else if( flRndSound <= 0.1f )	
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_pain2.wav", 1, ATTN_NORM );
	else if( flRndSound <= 0.2f )	
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_pain3.wav", 1, ATTN_NORM );
...
void CBasePlayer::DeathSound( void )
{
	...
	{
	case 1: 
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_death1.wav", 1, ATTN_NORM );
		break;
	case 2: 
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_death2.wav", 1, ATTN_NORM );
		break;
	case 3: 
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_death3.wav", 1, ATTN_NORM );
		break;
	case 4: 
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_death4.wav", 1, ATTN_NORM );
		break;
	case 5: 
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_death5.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CBasePlayer::Jump()
{
	...
	EMIT_SOUND( ENT( pev ), CHAN_VOICE, "player/pl_jump.wav", 1, ATTN_NORM );
